...
async def test__search_user_on_each_cts__user_is_bot_error_raised(
    bot: Bot,
) -> None:
    # - Arrange -
...
async def test__search_user_on_each__cts_not_found(
    bot: Bot,
) -> None:
    # - Arrange -
...
async def test__search_user_on_each_cts(
    bot: Bot,
) -> None:
    # - Arrange -
    user = UserFromSearch(
